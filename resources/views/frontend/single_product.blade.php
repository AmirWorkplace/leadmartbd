...
@section('content')
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="product-prices">
                            <div class="product-price d-flex align-items-center gap-2">
                                ...
                                @if ($product->price->regular_price != $first_variant->price)
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-reviews-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false">Reviews <span
                                class="text-xs">({{ count($product->reviews) }})</span></button>
                    </li>
                </ul>
    ...
    <section class="pb-md-5 pb-4 bg-white">
        <div class="container-fluid">
            <h3 class="h3 mb-4 text-uppercase text-center">Related Products</h3>
            <div class="row g-3">
                @foreach ($related_products as $related_product)
                    <div class="col-xxl-custom col-lg-3 col-md-4 col-6">
                        <div class="product-card">
                            <div class="product-card__image">
                                <a href="{{ Route('frontend.single-product', $related_product->slug) }}">
                                    <img src="{{ asset($related_product->thumbnail) }}"
                                        alt="{{ $related_product->name }}"></a>
                                <div class="product-card__action">
                                    <a href="#" class="quick-view" data-id="{{ $related_product->id }}">
                                        <i class="far fa-search"></i>
                                    </a>
                                    @auth
                                        <a class="addToWishlist" href="#" data-id="{{ $related_product->id }}">
                            ...
                            <div class="product-card__content">
                                <h6 class="product-card__title"><a
                                        href="{{ Route('frontend.single-product', $related_product->slug) }}">{{ $related_product->name }}</a>
                                </h6>
                                ...
                                <div class="product-card__price">
                                    @if ($related_product->price->sale_price != $related_product->price->regular_price)
                                        <del class="price">{{ $related_product->price->regular_price }}</del>
                                    @endif
                                    <span class="price">{{ $related_product->price->sale_price }}</span>
                                </div>
                                <a class="product-card__link"
                                    href="{{ Route('frontend.single-product', $related_product->slug) }}">
