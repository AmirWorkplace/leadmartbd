                                  ...
                                  <ul class="footer-links">
                                      @foreach ($menu->items as $item)
                                        @isset($item->category->slug)
                                          <li>
                                            <a class="footer-link"
                                              href="{{ !is_null($item->category_id) ? Route('frontend.products', $item->category->slug) : Route('frontend.page', $item->page->slug) }}">
                                              {{ $item->name }}
                                            </a>
                                          </li>
                                        @endisset
          ...
          <div class="footer-bottom">
              <div class="row g-3 align-items-center">
                  <div class="col-sm-6 text-sm-start text-center">
                      <div class="copyright">Copyright © {{ Carbon\Carbon::now()->year }} technoparkbd. All rights reserved.</div>
                  </div>
